...
if($product_category == "deal_of_day"){
  require_once './includes/functions.php'; // Include the file where the function is defined

  function get_deal_of_day_by_id($id) {
    global $conn; // Assuming $conn is your database connection
    $query = "SELECT * FROM deal_of_day WHERE id = ?";
        ...
        <?php include_once './product.php'; ?>
          ...
          <div class="product_detail_box">
            ...
            <div class="prouduct_information">
              ...
              <div class="product_description">
                ...
                <div class="product_detail">
                  <div class="price-box">
                    ...
                    <input type="hidden" id="product_identity" name="product_desc" value ="<?php echo $row['product_desc']; ?>">
              ...
              <div class="product_description">
                <div class="product_desc"><strong>Des: </strong></div>
                <div class="product_detail">

                <p >   <?php echo $row['product_desc']; ?>lorem20</p>
                </div>
              </div>
